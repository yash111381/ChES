...
$totalrows=mysqli_query($conn,"select * FROM blog");
$totalrows=mysqli_num_rows($totalrows);
$total=ceil($totalrows/$limit);

$sql = "SELECT uname,id,title,shortdesc,longdesc,blogimg,blogdate,name FROM blog ORDER BY blogdate DESC LIMIT $start, $limit";
            ...
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
				...
				mysqli_close($conn);?>
                 ...
                 <?php if($number>1){
					 $num=$number-1;	 
                 echo '<div class="col-md-3 col-sm-3 col-md-offet-3 col-sm-offset-3">
                 	<a href="blogs.php?number='.$num.'"  class="btn btn-danger">Previous</a>
                 </div>';
				 }
				 ?>
                 <?php if($number!=$total){
				$num=$number+1;
				if($number==1){
					echo '<div class="col-md-3 col-sm-3 col-md-offet-6 col-sm-offset-6">
                 	<a href="blogs.php?number='.$num.'"  class="btn btn-success">Next</a>
                 </div>';
				}else{
